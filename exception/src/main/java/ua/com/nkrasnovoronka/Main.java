...
public class Main {
    ...
    private static void doAction(CalendarController calendarController) {
        ...
        switch (userInputNumber) {
            case 1: {
                calendarController.chooseParserFormat();
                break;
            }
            case 2: {
                calendarController.addingService(calendarController.enterDate()).printCalendar(calendarController.getParserFormat());
                break;
            }
            case 3: {
                calendarController.subtractService(calendarController.enterDate()).printCalendar(calendarController.getParserFormat());
                break;
            }
            case 4: {
                calendarController.differenceService(calendarController.enterDate(), calendarController.enterDate());
                break;
            }
            case 5: {
                calendarController.calendarsSorting()
